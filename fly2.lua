...
RunService.Heartbeat:Connect(function()
    ...
    floatBtnObj.icon.Image = State.floating
        ...
        or  "rbxthumb://type=Asset&id=89324964776192&w=420&h=420"
    ...
    flyBtnObj.icon.Image = State.flying
        ...
        or  "rbxthumb://type=Asset&id=98943386790955&w=420&h=420"
    ...
    if State.boostCD or State.boostActive then
        ...
        boostBtnObj.icon.Image = "rbxthumb://type=Asset&id=97132627168916&w=420&h=420"
    end
    ...
    autoPilotBtnObj.icon.Image = State.autoPilot
        ...
        or  "rbxthumb://type=Asset&id=76493728917963&w=420&h=420"
end)
