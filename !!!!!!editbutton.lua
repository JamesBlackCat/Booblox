...
local function showSaveNameDialog(elementsData)
    ...
    saveBtn2.MouseButton1Click:Connect(doSave)
...
local function showExitDialog()
    ...
    discardOpt.MouseButton1Click:Connect(function()
        closeDialog()
        showDiscardConfirm(showExitDialog)
    end)

    saveOpt.MouseButton1Click:Connect(function()
...
EditLayoutBtn.MouseButton1Click:Connect(enterEditMode)
